          ...
          <div class="col-lg-6 col-md-6 col-xs-12">
            <table class="table">
              <tr>
                ...
                <td><span>$<?php echo  number_format($_SESSION['CoveragePlan'][0]["amount"],0,",","."); ?></span></td>
              </tr>
              <tr>
                <td><?php echo $_SESSION['CoveragePlan'][1]["coverage"]; ?></td>
                <td><span>$<?php echo  number_format($_SESSION['CoveragePlan'][1]["amount"],0,",","."); ?></span></td>
              </tr>
              <tr>
                <td><?php echo $_SESSION['CoveragePlan'][2]["coverage"]; ?></td>
                <td><span>$<?php echo  number_format($_SESSION['CoveragePlan'][2]["amount"],0,",","."); ?></span></td>
              </tr>
              <tr>
                <td><?php echo $_SESSION['CoveragePlan'][3]["coverage"]; ?></td>
                <td><span>$<?php echo  number_format($_SESSION['CoveragePlan'][3]["amount"],0,",","."); ?></span></td>
              </tr>
              <tr>
                <td><?php echo $_SESSION['CoveragePlan'][4]["coverage"]; ?></td>
                <td><span>$<?php echo  number_format($_SESSION['CoveragePlan'][4]["amount"],0,",","."); ?></span></td>
              </tr>
            </table>
          </div>
          <div class="col-lg-6 col-md-6 col-xs-12">
            <table class="table">
              <tr>
                ...
                <td><span>$<?php echo  number_format($_SESSION['CoveragePlan'][5]["amount"],0,",","."); ?></span></td>
              </tr>
              <tr>
                <td><?php echo $_SESSION['CoveragePlan'][6]["coverage"]; ?></td>
                <td><span>$<?php echo  number_format($_SESSION['CoveragePlan'][6]["amount"],0,",","."); ?></span></td>
              </tr>
              <tr>
                <td><?php echo $_SESSION['CoveragePlan'][7]["coverage"]; ?></td>
                <td><span>$<?php echo  number_format($_SESSION['CoveragePlan'][7]["amount"],0,",","."); ?></span></td>
              </tr>
              <tr>
                <td><?php echo $_SESSION['CoveragePlan'][8]["coverage"]; ?></td>
                <td><span>$<?php echo  number_format($_SESSION['CoveragePlan'][8]["amount"],0,",","."); ?></span></td>
              </tr>
              <tr>
                <td><?php echo $_SESSION['CoveragePlan'][9]["coverage"]; ?></td>
                <td><span>$<?php echo  number_format($_SESSION['CoveragePlan'][9]["amount"],0,",","."); ?></span></td>
              </tr>
            </table>
