        ...
        <div >
          ...
          <main role="main" class="inner cover main-form">
            ...
            <form id="dProspect" method="post" class="form" action="https://cs52.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" onsubmit="return ValidateForm()">
              ...
              <div class="row justify-content-lg-center">
                <div class="col-lg-4 col-sm-12">
                  <select required class="form-control" name="00N5B000001IgcN" id="00N5B000001IgcN">
              ...
              <div class="row justify-content-lg-center">
                <div class="col-lg-2 col-sm-12">
                  <select required class="form-control" name="00N5B000001IgcO" id="00N5B000001IgcO">
                ...
                <div class="col-lg-2 col-sm-12">
                  <input type="text" required class="form-control" pattern=".{3,4}" required onKeyPress="return numberOnly(event);" title="Código de área de 3 a 4 dígitos" maxlength="4" name="00N5B000001IgcE" id="00N5B000001IgcE" placeholder="COD. ÁREA">
                </div> 
                <div class="col-lg-4 col-sm-12">
              ...
              <div class="row justify-content-lg-center">
                ...
                <div class="col-lg-4 col-sm-12">
                  <select required class="form-control" name="00N5B000001IgcK" id="00N5B000001IgcK">
              ...
              <div class="row justify-content-lg-center">
                <div class="col-lg-4 col-sm-12">
                  <select required class="form-control" name="00N5B000001IgcL" id="00N5B000001IgcL">
