        ...
        <div >
          ...
          <main role="main" class="inner cover main-form">
            ...
            <form id="dProspect" method="post" class="form" action="https://na78.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" onsubmit="return ValidateForm()">
              ...
              <div class="row justify-content-lg-center">
                <div class="col-lg-4 col-sm-12">
                  <select required class="form-control" name="00N1N00000P57nA" id="00N1N00000P57nA">
              ...
              <div class="row justify-content-lg-center">
                ...
                <div class="col-lg-2 col-sm-12">
                  <input type="text" required class="form-control" pattern=".{3,4}" required onKeyPress="return numberOnly(event);" title="Código de área de 3 a 4 dígitos" maxlength="4" name="00N1N00000P57n1" id="00N1N00000P57n1" placeholder="COD. ÁREA">
                </div> 
                <div class="col-lg-4 col-sm-12">
              ...
              <div class="row justify-content-lg-center">
                ...
                <div class="col-lg-4 col-sm-12">
                  <select required class="form-control" name="00N1N00000P57n7" id="00N1N00000P57n7">
              ...
              <div class="row justify-content-lg-center">
                <div class="col-lg-4 col-sm-12">
                  <select required class="form-control" name="00N1N00000P57n8" id="00N1N00000P57n8">
