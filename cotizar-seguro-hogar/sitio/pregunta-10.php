...
<html lang="en">
  ...
  <body class="">
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-10').'</div>';
          ...
          <main role="main" class="inner question-wide">
            ...
            <div class="answer-section">
              <div class="slider-section">
                <div class="question">
                  <h2 class="question-title"><?php echo get_NameQuestion('10'); ?></h2>

                  <div class="slider"></div>
                  <div class="slider-max-min">
                    <div class="min">Un finde largo con feriado puente.</div>
                    <div class="max">Años luz.</div>
                  </div>
                </div>
                <div class="slider-images">
                  <img src="images/Asset38.png" id="image-min">
                  <img src="images/Asset37-2.png" id="image-med">
                  <img src="images/Asset37.png" id="image-max">
                </div>
              </div>
            </div>
          </main>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 button-left" >
            	<div class="question-navigation">
            		<a href="pregunta-9.php"><!--div class="btn-black"><img src="images/arrow-left.png"></div--></a>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-10.js"></script>
