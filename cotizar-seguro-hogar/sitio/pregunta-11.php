...
<html lang="en">
  ...
  <body class="">
    ...
    <div class="site-wrapper background-yellow-orange">
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-11').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <div class="answer-section">
              <div class="multiple-selection-vertical">
                <div class="questions">
                  <h2 class="question-title" style="text-align: left;padding-left: 10px;"><?php echo get_NameQuestion('11'); ?></h2>
                  <form>
                    <ul>
                      <li>
                        <input type="checkbox" id="option-1" name="checkboxvertical" data-image="Asset42.png" 
                              value="Las pantuflas de oso" data-animation="fadeIn" checked>
                        <label for="option-1">Las pantuflas de oso.</label>
                        
                        <div class="check"></div>
                      </li>
                      
                      <li>
                        <input type="checkbox" id="option-2" name="checkboxvertical" data-image="Asset40.png"
                              value="El radio despertador bluetooth" data-animation="slideDown">
                        <label for="option-2">El radio despertador bluetooth.</label>
                        
                        <div class="check"><div class="inside"></div></div>
                      </li>
                      
                      <li>
                        <input type="checkbox" id="option-3" name="checkboxvertical" data-image="Asset41.png"
                              value="Tu sommier de espuma de alta densidad" data-animation="fadeIn">
                        <label for="option-3">Tu sommier de espuma de alta densidad.</label>
                      ...
                      <li>
                        <input type="checkbox" id="option-4" name="checkboxvertical" data-image="Asset43-nada.png"
                      ...
                      <li>
                        <input type="checkbox" id="option-5" name="checkboxvertical" data-image="Asset43.png "
                ...
                <div class="images">
                  <img src="images/Asset42.png" id="image-holder">
                </div>
              </div>
            </div>
          </main>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 button-left" >
            	<div class="question-navigation">
            		<a href="pregunta-10.php"><!--div class="btn-black"><img src="images/arrow-left.png"></div--></a>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-11.js"></script>
    <script>
