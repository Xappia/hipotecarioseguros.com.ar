...
<html lang="en">
  ...
  <body class="">
    ...
    <div class="site-wrapper background-green-blue-2">
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-13').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <div class="answer-section">
              <div class="multiple-selection-vertical">
                <div class="questions">
                  <h2 class="question-title" style="text-align: left;padding-left: 25px;"><?php echo get_NameQuestion('13'); ?></h2>
                  <form>
                    <ul>
                      <li>
                        <input type="checkbox" id="option-1" name="checkboxvertical" data-image="Asset48.png" 
                              value="Los Malbecs cosecha 1886" data-animation="fadeIn" checked>
                        <label for="option-1">Los Malbecs cosecha 2006.</label>
                        
                        <div class="check"></div>
                      </li>
                      
                      <li>
                        <input type="checkbox" id="option-2" name="checkboxvertical" data-image="Asset49.png"
                              value="El radio despertador bluetooth" data-animation="slideDown">
                        <label for="option-2">La heladera con los imanes del delivery.</label>
                        
                        <div class="check"><div class="inside"></div></div>
                      </li>
                      
                      <li>
                        <input type="checkbox" id="option-3" name="checkboxvertical" data-image="Asset50.png"
                              value="Las vasijas de Machu Pichu" data-animation="fadeIn">
                        <label for="option-3">Las vasijas de Machu Pichu.</label>
                      ...
                      <li>
                        <input type="checkbox" id="option-4" name="checkboxvertical" data-image="Asset51-nada.png"
                      ...
                      <li>
                        <input type="checkbox" id="option-5" name="checkboxvertical" data-image="Asset51.png"
                ...
                <div class="images">
                  <img src="images/Asset48.png" id="image-holder">
                </div>
              </div>
            </div>
          </main>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 button-left" >
            	<div class="question-navigation">
            		<a href="pregunta-12.php"><!--div class="btn-black"><img src="images/arrow-left.png"></div--></a>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-13.js"></script>
    <script>
