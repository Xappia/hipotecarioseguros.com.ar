...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div >
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-14').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title"><?php echo get_NameQuestion('14'); ?></h2>
            <div class="answer-section">
              <div class="one-selection-horizontal">
                <form>
                  <ul>
                    <li>
                      <input type="radio" id="option-1" name="radiohorizontal" value="electrodomesticos" checked>
                        <label for="option-1">
                          <img src="images/Asset52.png">
                    ...
                    <li>          
                      <input type="radio" id="option-2" name="radiohorizontal" value="muebles">
                        <label for="option-2">
                            <img src="images/Asset53.png">
                            <div class="check"><div class="inside"></div></div>
                            <span>Los muebles del living.</span>
                        </label>
                    </li>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-14.js"></script>
