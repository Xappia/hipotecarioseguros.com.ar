...
<html lang="en">
  ...
  <body class="">
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-15').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <div class="answer-section">
              <div class="multiple-selection-vertical">
                <div class="questions">
                  <h2 class="question-title" style="text-align: left;padding-left: 20px;"><?php echo get_NameQuestion('15'); ?></h2>
                  <form>
                    <ul>
                      <li>
                        <input type="checkbox" id="option-1" name="checkboxvertical" data-image="Asset55.png" 
                              value="caja" data-animation="fadeIn" checked>
                        <label for="option-1">La caja de herramientas alemana.</label>
                        
                        <div class="check"></div>
                      </li>
                      
                      <li>
                        <input type="checkbox" id="option-2" name="checkboxvertical" data-image="Asset56.png"
                              value="bicis" data-animation="slideDown">
                        <label for="option-2">Las bicis de los chicos.</label>
                        
                        <div class="check"><div class="inside"></div></div>
                      </li>
                      
                      <li>
                        <input type="checkbox" id="option-3" name="checkboxvertical" data-image="Asset57.png"
                              value="cortadora" data-animation="fadeIn">
                        <label for="option-3">La cortadora de césped.</label>
                      ...
                      <li>
                        <input type="checkbox" id="option-4" name="checkboxvertical" data-image="Asset58-nada.png"
                       ...
                       <li>
                        <input type="checkbox" id="option-5" name="checkboxvertical" data-image="Asset58.png"
                ...
                <div class="images">
                  <img src="images/Asset55.png" id="image-holder">
                </div>
              </div>
            </div>
          </main>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-15.js"></script>
    <script>
