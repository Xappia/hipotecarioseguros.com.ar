...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div >
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-17').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title"><?php echo get_NameQuestion('17'); ?></h2>
                  ...
                  <ul>
                    <li>
                      <input type="radio" id="option-1" name="radiohorizontal" value="Doble puerta" checked>
                        <label for="option-1">
                          <img src="images/Asset59.png">
                          <div class="check"><div class="inside"></div></div>
                            <span>Doble puerta.</span>
                        </label>
                    </li>
          ...
          <footer class="mastfoot">
            <div class="">
            	<div class="question-navigation">
            		<a href="pregunta-16.php"><!--div class="btn-black"><img src="images/arrow-left.png"></div--></a>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-17.js"></script>
