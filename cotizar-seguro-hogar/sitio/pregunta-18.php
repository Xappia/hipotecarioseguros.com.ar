...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div >
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-18').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title"><?php echo get_NameQuestion('18'); ?></h2>
            <div class="answer-section">
              <div class="one-selection-horizontal">
                <form>
                  <ul>
                    <li>
                      <input type="radio" id="option-1" name="radiohorizontal" value="Doble puerta" checked>
                        <label for="option-1">
                          <img src="images/Asset64.png">
                          <div class="check"><div class="inside"></div></div>
                          <span>Un super Led de 55”.</span>
                        </label>
                    </li>
                    
                    <li>          
                      <input type="radio" id="option-2" name="radiohorizontal" value="Mediana">
                        <label for="option-2">
                            <img src="images/Asset63.png">
                            <div class="check"><div class="inside"></div></div>
                            <span>Un LCD.</span>
                        </label>
                    </li>
                    <li>          
                      <input type="radio" id="option-3" name="radiohorizontal" value="Compacta">
                        <label for="option-3">
                            <img src="images/Asset62.png">
                            <div class="check"><div class="inside"></div></div>
                            <span>La compu es mi Tele.</span>
                        </label>
                    </li>
          ...
          <footer class="mastfoot">
            <div class="">
            	<div class="question-navigation">
            		<a href="pregunta-17.php"><!--div class="btn-black"><img src="images/arrow-left.png"></div--></a>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-18.js"></script>
