...
<html lang="en">
  ...
  <body class="">
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-23').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <div class="answer-section">
              <div class="multiple-selection-vertical">
                <div class="questions">
                  <h2 class="question-title" style="text-align: left;padding-left: 20px;"><?php echo get_NameQuestion('23'); ?></h2>
                  <form>
                    <ul>
                      <li>
                        <input type="checkbox" id="option-1" name="checkboxvertical" data-image="Asset82.png" 
                              value="rollers" data-animation="fadeIn" checked>
                        <label for="option-1">Los rollers.</label>
                        <div class="check"></div>
                      </li>
                      
                      <li>
                        <input type="checkbox" id="option-2" name="checkboxvertical" data-image="Asset83.png"
                              value="camisetas" data-animation="slideDown">
                        <label for="option-2">Las camisetas de fútbol.</label>
                        <div class="check"><div class="inside"></div></div>
                      </li>
                      
                      <li>
                        <input type="checkbox" id="option-3" name="checkboxvertical" data-image="Asset84.png"
                              value="camperas" data-animation="fadeIn">
                        <label for="option-3">Todas las camperas y abrigos.</label>
                        <div class="check"><div class="inside"></div></div>
                      </li>
                      <li>
                        <input type="checkbox" id="option-4" name="checkboxvertical" data-image="Asset85-nada.png"
                      ...
                      <li>
                        <input type="checkbox" id="option-5" name="checkboxvertical" data-image="Asset85.png"
                ...
                <div class="images">
                  <img src="images/Asset82.png" id="image-holder">
                </div>
              </div>
            </div>
          </main>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-23.js"></script>
    <script>
