...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div >
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-24').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title"><?php echo get_NameQuestion('24'); ?></h2>
                  ...
                  <ul>
                    ...
                    <li>          
                      <input type="radio" id="option-3" name="radiohorizontal" value="Terceros">
                        <label for="option-3">
                            <img src="images/Asset91.png">
                            <div class="check"><div class="inside"></div></div>
                            <span>Daños de Terceros.</span>
                        </label>
                    </li>
                    <li>          
                      <input type="radio" id="option-4" name="radiohorizontal" value="Todas">
                        <label for="option-4">
                            <img src="images/Asset92.png">
                            <div class="check"><div class="inside"></div></div>
          ...
          <footer class="mastfoot">
            <div class="">
            	<div class="question-navigation">
            		<a href="pregunta-23.php"><!--div class="btn-black"><img src="images/arrow-left.png"></div--></a>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-24.js"></script>
    <script>
