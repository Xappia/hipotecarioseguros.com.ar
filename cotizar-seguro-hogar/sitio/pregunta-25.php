...
<html lang="en">
   ...
   <body class="">
         ...
         <div class="site-wrapper-inner">
            <div >
                  ...
                  <div class="inner">
                     ...
                     <nav class="nav nav-masthead question-pagination">
					  <?php
						...
						echo '<div class="current">'.NumberQuestionsOnArray('pregunta-25').'</div>';
               ...
               <main role="main" class="inner question-wide">
                  <h2 class="question-title" style="margin-bottom: 5px"><?php echo get_NameQuestion('25'); ?></h2>
                        ...
                        <div class="row justify-content-lg-center mh-30 mh-30-30">
                          ...
                          <div class="multiple-selection wide">
                              <div>
                                 ...
                                 <label for="c4">
                                    <div>Cuchillo eléctrico </div>
                                 </label>
                              </div>
                              <div>
                                 <input type="checkbox" id="c5">
                                 <label for="c5">
                                    <div>La tostadora </div>
                                 </label>
                              </div>
                          ...
                          <div class="multiple-selection wide">    
                              <div>
                                 ...
                                 <label for="c6">
                                    <div>La Minipimer </div>
                                 </label>
                              </div>
                              <div>
                                 <input type="checkbox" id="c7">
                                 <label for="c7">
                                    <div>El microondas</div>
                                 </label>
                              </div>
                              <div>
                                 <input type="checkbox" id="c8">
                                 <label for="c8">
                                    <div>La parrilla eléctrica </div>
                                 </label>
                              </div>
                          ...
                          <div class="multiple-selection wide">   
                              <div>
                                 ...
                                 <label for="c9">
                                    <div>La licuadora </div>
                                 </label>
                              </div>
                              <div>
                                 <input type="checkbox" id="c10">
                                 <label for="c10">
                                    <div>El Purificador de aire </div>
                                 </label>
                              </div>
                          </div>
                          <div class="multiple-selection wide">   
                              <div>
                                 ...
                                 <label for="c11">
                                    <div>La multiprocesadora </div>
                                 </label>
                              </div>
                              <div>
                                 <input type="checkbox" id="c12">
                                 <label for="c12">
                                    <div>La pava eléctrica</div>
                                 </label>
                              </div>
                              <div>
	...
	<div style="display:inline;">
      ...
      <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-25.js"></script>
      <script type="text/javascript">
