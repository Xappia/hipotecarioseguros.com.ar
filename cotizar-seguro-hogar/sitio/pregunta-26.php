...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div >
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
					  <?php
						...
						echo '<div class="current">'.NumberQuestionsOnArray('pregunta-26').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title"><?php echo get_NameQuestion('26'); ?></h2>
                  ...
                  <ul>
                    <li>
                      <input type="radio" id="option-1" name="radiohorizontal" value="Robo" checked>
                        <label for="option-1">
                          <img src="images/Asset93.png">
                          <div class="check"><div class="inside"></div></div>
                          <span>Sillones y/o<br>futones.</span>
                        </label>
                    </li>
                    ...
                    <li>          
                      <input type="radio" id="option-2" name="radiohorizontal" value="Incendio">
                        <label for="option-2">
                            <img src="images/Asset94.png">
                            <div class="check"><div class="inside"></div></div>
                            <span>Mesas de TV,<br>racks y modulares.</span>
                        </label>
                    </li>
                    <li>          
                      <input type="radio" id="option-3" name="radiohorizontal" value="Terceros">
                        <label for="option-3">
                            <img src="images/Asset95.png">
                            <div class="check"><div class="inside"></div></div>
                            <span style="height: 30px">Mesas y sillas.<br></span>
                        </label>
                    </li>
                    <li>          
                      <input type="radio" id="option-4" name="radiohorizontal" value="Todas">
                        <label for="option-4">
                            <img src="images/Asset96.png">
                            <div class="check"><div class="inside"></div></div>
                            <span style="height: 30px">Alfombra.<br></span>
                        </label>
                    </li>
                  </ul>
                </form>
          ...
          <footer class="mastfoot">
            <div class="">
            	<div class="question-navigation">
            		<a href="pregunta-25.php"><!--div class="btn-black"><img src="images/arrow-left.png"></div--></a>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-26.js"></script>
    <script>
