...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div >
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title"><?php echo get_NameQuestion('30'); ?></h2>
            <div class="answer-section">
              <span class="sortable-order left"><img src="images/less.png"></span>
              <ul id="sortable" class="sortable bigger">
                <li value="1">
                  <div><img src="images/Asset97.png"></div>
                  <span class="name">Lavarropas</span>
                </li>
                <li value="2">
                  <div><img src="images/Asset98.png"></div>
                  <span class="name">Termotanque</span>
                </li>
                <li value="3">
                  <div><img src="images/Asset99.png"></div>
                  <span class="name">Heladera</span>
                </li>
                <li value="4">
                  <div><img src="images/Asset100.png"></div>
                  <span class="name">Lavavajillas</span>
                </li>
                <li value="5">
                  <div><img src="images/Asset101.png"></div>
                  <span class="name">Horno</span>
                </li>
                <li value="6">
                  <div><img src="images/Asset102.png"></div>
                  <span class="name" style="font-size: 8px">Aire acondicionado</span>
                </li>
              </ul>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-30.js"></script>
    <script>
