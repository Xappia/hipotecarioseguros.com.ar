...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div >
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-33').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title"><?php echo get_NameQuestion('33'); ?></h2>
          ...
          <footer class="mastfoot">
            <div class="">
            	<div class="question-navigation">
            		<a href="pregunta-32.php"><!--div class="btn-black"><img src="images/arrow-left.png"></div--></a>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-33.js"></script>
    <script>
