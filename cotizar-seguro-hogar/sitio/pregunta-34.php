...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div >
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-34').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title"><?php echo get_NameQuestion('34'); ?></h2>
            <div class="answer-section">
              <span class="sortable-order left"><img src="images/less.png"></span>
              <ul id="sortable" class="sortable bigger">
                <li value="1">
                  <div><img src="images/Asset109.png"></div>
                  <span class="name">La camiseta de Messi</span>
                </li>
                <li value="2">
                  <div><img src="images/Asset110.png"></div>
                  <span class="name">La Caja de Herramientas</span>
                </li>
                <li value="3">
                  <div><img src="images/Asset111.png"></div>
                  <span class="name">La cortadora de césped</span>
                </li>
                <li value="4">
                  <div><img src="images/Asset112.png"></div>
                  <span class="name">La afeitadora eléctrica</span>
                </li>
                <li value="5">
                  <div><img src="images/Asset113.png"></div>
                  <span class="name">La caña de pescar</span>
                </li>
                <li value="6">
                  <div><img src="images/Asset114.png"></div>
                  <span class="name">La Play</span>
                </li>
              </ul>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-34.js"></script>
    <script>
