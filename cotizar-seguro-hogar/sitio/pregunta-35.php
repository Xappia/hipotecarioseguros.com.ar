...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div >
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-35').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title"><?php echo get_NameQuestion('35'); ?></h2>
            <div class="answer-section">
              <span class="sortable-order left"><img src="images/less.png"></span>
              <ul id="sortable" class="sortable bigger">
                <li value="1">
                  <div><img src="images/Asset146.png"></div>
                  <span class="name">Mis perfumes importados</span>
                </li>
                <li value="2">
                  <div><img src="images/Asset147.png"></div>
                  <span class="name">mis carteras y bolsos</span>
                </li>
                <li value="3">
                  <div><img src="images/Asset148.png"></div>
                  <span class="name">El set de maquillaje</span>
                </li>
                <li value="4">
                  <div><img src="images/Asset149.png"></div>
                  <span class="name">La planchita eléctrica</span>
                </li>
                <li value="5">
                  <div><img src="images/Asset150.png"></div>
                  <span class="name">Joyas / Bijouterie</span>
                </li>
                <li value="6">
                  <div><img src="images/Asset156.png"></div>
                  <span class="name">Mis zapatos</span>
                </li>
              </ul>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-35.js"></script>
    <script>
