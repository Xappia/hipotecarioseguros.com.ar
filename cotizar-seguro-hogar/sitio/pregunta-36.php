...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div >
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-36').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title"><?php echo get_NameQuestion('36'); ?></h2>
            <div class="answer-section">
              <span class="sortable-order left"><img src="images/less.png"></span>
              <ul id="sortable" class="sortable bigger">
                <li value="1">
                  <div><img src="images/Asset115.png"></div>
                  <span class="name">Muebles de Living</span>
                </li>
                <li value="2">
                  <div><img src="images/Asset116.png"></div>
                  <span class="name">Muebles de Cocina</span>
                </li>
                <li value="3">
                  <div><img src="images/Asset117.png"></div>
                  <span class="name">Muebles de dormitorio</span>
                </li>
                <li value="4">
                  <div><img src="images/Asset118.png"></div>
                  <span class="name">Muebles de comedor</span>
                </li>
              </ul>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-36.js"></script>
    <script>
