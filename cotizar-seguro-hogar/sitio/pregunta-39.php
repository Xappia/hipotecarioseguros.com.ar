...
<html lang="en">
  ...
  <body class="">
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-39').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <div class="answer-section">
              <div class="multiple-selection-vertical">
                <div class="questions">
                  <h2 class="question-title" style="text-align: left;padding-left: 20px;"><?php echo get_NameQuestion('39'); ?></h2>
                  <form>
                    <ul>
                      <li>
                        <input type="checkbox" id="option-1" name="checkboxvertical" data-image="Asset157.png" 
                              value="Scalextric" data-animation="fadeIn" checked>
                        <label for="option-1">Rejas.</label>
                        
                        <div class="check"></div>
                      </li>
                      
                      <li>
                        <input type="checkbox" id="option-2" name="checkboxvertical" data-image="Asset158.png"
                              value="bici" data-animation="slideDown">
                        <label for="option-2">Persianas.</label>
                        
                        <div class="check"><div class="inside"></div></div>
                      </li>
                      
                      <li>
                        <input type="checkbox" id="option-3" name="checkboxvertical" data-image="Asset159.png"
                              value="camping" data-animation="fadeIn">
                        <label for="option-3">Doble vidrio.</label>
                        
                        <div class="check"><div class="inside"></div></div>
                      </li>

                      <li>
                        <input type="checkbox" id="option-4" name="checkboxvertical" data-image="Asset159-nada.png"
                ...
                <div class="images">
                  <img src="images/Asset157.png" id="image-holder">
                </div>
              </div>
            </div>
          </main>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-39.js"></script>
    <script>
