...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title"><?php echo get_NameQuestion('4'); ?></h2>
            <div class="answer-section">
              <span class="sortable-order left"><img src="images/less.png"></span>
              <ul id="sortable" class="sortable bigger">
                
                <li value="1">
                  <div><img src="images/fuego.png"></div>
                  <span class="name">Incendio</span>
                </li>
                <li value="2">
                  <div><img src="images/robo.png"></div>
                  <span class="name">Robo</span>
                </li>
                <li value="3">
                  <div><img src="images/granizo.png"></div>
                  <span class="name">Granizo</span>
                </li>
                <li value="4">
                  <div><img src="images/tu-tecnologia.png"></div>
                  <span class="name large">Electrodomésticos<br>Tecnología</span>
                </li>
              </ul>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-4.js"></script>
    <script>
