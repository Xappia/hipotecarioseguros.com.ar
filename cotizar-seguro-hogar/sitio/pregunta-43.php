...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div >
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-43').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title" style="margin-bottom: 5px"><?php echo get_NameQuestion('43'); ?>  </h2>
                  ...
                  <ul>
                    ...
                    <li>          
                      <input type="radio" id="option-3" name="radiohorizontal" value="Terceros">
                        <label for="option-3">
                            <img src="images/Asset140.png">
                            <div class="check"><div class="inside"></div></div>
                            <span>Más de 2 (DOS).</span>
                        </label>
                    </li>
                  </ul>
                </form>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-43.js"></script>
    <script>
