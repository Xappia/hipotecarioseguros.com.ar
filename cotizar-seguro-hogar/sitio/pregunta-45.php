...
<html lang="en">
  ...
  <body class="">
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-45').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <div class="answer-section">
              <div class="multiple-selection-vertical">
                <div class="questions">
                  <h2 class="question-title" style="text-align: left;padding-left: 20px;"><?php echo get_NameQuestion('45'); ?>  </h2>
                  <form>
                    <ul>
                      <li>
                        <input type="checkbox" id="option-1" name="checkboxvertical" data-image="Asset171.png" 
                              value="Scalextric" data-animation="fadeIn" checked>
                        <label for="option-1">LOS UNIFORMES DEL COLEGIO / GUARDAPOLVOS.</label>
                        
                        <div class="check"></div>
                      </li>
                      
                      <li>
                        <input type="checkbox" id="option-2" name="checkboxvertical" data-image="Asset172.png"
                              value="bici" data-animation="slideDown">
                        <label for="option-2">LOS DISFRACES.</label>
                        
                        <div class="check"><div class="inside"></div></div>
                      </li>
                      
                      <li>
                        <input type="checkbox" id="option-3" name="checkboxvertical" data-image="Asset173.png"
                              value="camping" data-animation="fadeIn">
                        <label for="option-3">LOS ESQUIPOS DEPORTIVOS.</label>
                        
                        <div class="check"><div class="inside"></div></div>
                      </li>

                      <li>
                        <input type="checkbox" id="option-4" name="checkboxvertical" data-image="Asset174.png"
                      ...
                      <li>
                        <input type="checkbox" id="option-5" name="checkboxvertical" data-image="Asset175.png"
                              value="Todos" data-animation="slideDown">
                ...
                <div class="images">
                  <img src="images/Asset171.png" id="image-holder">
                </div>
              </div>
            </div>
          </main>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 button-left" >
            	<div class="question-navigation">
            		<a href="pregunta-44.php"><!--div class="btn-black"><img src="images/arrow-left.png"></div--></a>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-45.js"></script>
    <script>
