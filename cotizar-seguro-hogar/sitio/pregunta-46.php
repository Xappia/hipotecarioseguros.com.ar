...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div >
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-46').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title"><?php echo get_NameQuestion('46'); ?></h2>
            <div class="answer-section">
              <span class="sortable-order left"><img src="images/less.png"></span>
              <ul id="sortable" class="sortable">
                <li value="1">
                  <div><img src="images/Asset141.png"></div>
                  <span class="name" style="font-size: .56rem">Computadora/ Notebook</span>
                </li>
                <li value="2">
                  <div><img src="images/Asset142.png"></div>
                  <span class="name">TV y Home theater</span>
                </li>
                <li value="3">
                  <div><img src="images/Asset143.png"></div>
                  <span class="name" style="font-size: 8px">Consolas de entretenimiento</span>
                </li>
                <li value="4">
                  <div><img src="images/Asset144.png"></div>
                  <span class="name" style="font-size: .56rem">Reproductores de audio</span>
                </li>
                <li value="5">
                  <div><img src="images/Asset145.png"></div>
                  <span class="name" style="font-size: 7px">Electrodómesticos de cocina</span>
                </li>
              </ul>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-46.js"></script>
    <script>
