...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="site-wrapper-inner">
        ...
        <div >
            ...
            <div class="inner">
              ...
              <nav class="nav nav-masthead question-pagination">
				  <?php
					...
					echo '<div class="current">'.NumberQuestionsOnArray('pregunta-7').'</div>';
          ...
          <main role="main" class="inner question-wide">
            <h2 class="question-title"><?php echo get_NameQuestion('7'); ?></h2>
            <div class="answer-section">
              <span class="sortable-order left"><img src="images/less.png"></span>
              <ul id="sortable" class="sortable">
                <li value="1">
                  <div><img src="images/Asset34.png"></div>
                  <span class="name">La panquequera</span>
                </li>
                <li value="2">
                  <div><img src="images/Asset32.png"></div>
                  <span class="name">La plancha a vapor</span>
                </li>
                <li value="3">
                  <div><img src="images/Asset31.png"></div>
                  <span class="name">La cafetera express</span>
                </li>
                <li value="4">
                  <div><img src="images/Asset33.png"></div>
                  <span class="name">El taladro eléctrico multiuso</span>
                </li>
                <li value="5">
                  <div><img src="images/Asset35.png"></div>
                  <span class="name">El secador de pelo</span>
                </li>
              </ul>
    ...
    <script language="javascript" type="text/javascript" src="js/preguntas/pregunta-7.js"></script>
