...
function my_conversion( $cf7 )
{
  ...
  $first_name  = $cf7->posted_data['first_name'];
  $last_name  = $cf7->posted_data['last_name'];
  ...
  $post_items[] = 'first_name=a' . $first_name;
  $post_items[] = 'last_name=b' . $last_name;
  $post_items[] = 'email=' . $email;
  $post_items[] = 'phone=' . $phone;
  $post_items[] = 'description=c' . $description;
  $post_items[] = '00No00000093eG7=d'. $subject;
