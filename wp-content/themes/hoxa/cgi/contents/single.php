 ...
 ?>
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<?php 
						...
						<div class="sharepost">
						    <h4><?php _e('Compartir este Post','devn'); ?></h4>
						    <ul>
						...
						?>
							<nav id="nav-single">
								<span class="nav-previous"><?php previous_post_link( '%link', __( '<span class="meta-nav">&larr;</span> Artículo anterior', 'devn' ) ); ?></span>
								<span class="nav-next"><?php next_post_link( '%link', __( 'Siguiente Artículo<span class="meta-nav">&rarr;</span>', 'devn' ) ); ?></span>
							</nav><!-- #nav-single -->
						<?php 
