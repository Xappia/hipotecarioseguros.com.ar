	...
	<ul class="<?php echo $class; ?>">
		...
		?>
			 <li class="post_comments">
	            <a  title="'.__('Click para dejar un comentario','devn').'" href="#respond">
	            	<?php echo comments_number( '0 comentarios', '1 comentario', '% comentarios' ); ?>
	            </a>
	        </li>
	    <?php  
		}
...
function breadcrumb() {
    ...
    if ( !is_front_page() ) {
		echo '<a href="'.home_url().'">'.__('Inicio','devn')."</a> ";
	}
...
<meta name="generator" content="bhse" />
...
?>
<meta property="og:type" content="bhse:photo" />
...
<meta name="author" content="Hipotecario Seguros" />
<meta name="contact" content="consultas@hipotecarioseguros.com.ar" />
<meta name="copyright" content="Copyright (c). Derechos reservados." />
